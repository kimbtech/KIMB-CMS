function editorloader_setcodem(){if(typeof editorloader_hasmd!=="undefined"&&editorloader_hasmd){var locst=window.localStorage.getItem("editorloader");if(locst!="tinymce"&&locst!="codemirror"&&locst!="textarea"){window.localStorage.setItem("editorloader","codemirror")}}}
...
function reload_all(old,editor){if(old=="tinymce"){editorloader_ids.forEach(function(v){tinymce.EditorManager.execCommand("mceRemoveEditor",!0,v)})}
...
else{editorloader_ids.forEach(function(v){tinymce.EditorManager.execCommand("mceRemoveEditor",!0,v)})}
