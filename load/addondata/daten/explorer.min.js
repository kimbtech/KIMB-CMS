function show_error(a,b,c){$(c).html('<div class="ui-widget"><div class="ui-state-error ui-corner-all" style="padding: 5px;"><span class="ui-icon ui-icon-alert" style="float: left; margin-right: 6px;"></span><strong>'+a+"</strong>&nbsp;&nbsp;&nbsp;"+b+"</div></div>");return!0}Dropzone.autoDiscover=!1;
function j_alert(a,b){"undefined"===typeof b&&(b=300);$("div.j_alert").length&&$("div.j_alert").remove();var c;c='<div class="j_alert" title="Wichtig!!">'+a+"</div>";$("body").prepend(c);$("div.j_alert").dialog({modal:!0,width:b,buttons:{OK:function(){$(this).dialog("close")}}})}$(function(){load_daten()});var cssclass="div.addon_daten_main ";
...
c?($("div.main_files").html(b),$("div.pathbar").unbind("dblclick").dblclick(function(){var a=$(this).html();-1===a.indexOf("<input")&&($(this).html('<input type="text" style="width:95%;" value="'+a+'">'),$(this).children("input").keyup(function(b){13==b.keyCode?(b=$(this).val(),$(this).parent().html(b),allgvars.path=b,main_explorer()):17==b.keyCode&&$(this).parent().html(a)}))}),$("ul.files li").unbind("click").click(function(){var a=$(this).attr("ftype"),b=$(this).attr("url"),c=$(this).attr("name");
"dir"==a?(allgvars.path=allgvars.path+b+"/",main_explorer()):"file"==a?open_file(b):"kt"==a&&open_table(b,c)}),$("button#add_table").unbind("click").click(function(){$("div.toolbar span").css("display","inline");$("div.toolbar span input").unbind("keyup").keyup(function(a){13==a.keyCode?(a=$(this).val(),open_table(a+".kimb_table",a,!0),$("div.toolbar span").css("display","none")):17==a.keyCode&&$("div.toolbar span").css("display","none")})}),$("button#add_file").unbind("click").click(function(){var a;
