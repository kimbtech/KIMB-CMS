...
if( !is_dir( __DIR__.'/../felogin/' ) ){
	...
	$sitecontent->echo_message( 'Das Add-on "felogin" wurde nicht gefunden, bitte installieren und aktivieren Sie es um einen erweiterten Funktionsumfang von "kontakt" zu erhalten!' );

}
elseif( !$this->addoninclude->read_kimb_search_teilpl( 'fe_first' , 'felogin' ) ){

	$sitecontent->echo_message( 'Das Add-on "felogin" scheint nicht aktiviert zu sein, bitte aktivieren Sie es um einen erweiterten Funktionsumfang von "kontakt" zu erhalten!' );
