...
//Diese Datei erstellt Exportdateien

//sind schon Auswahlen  getroffen?
if( isset( $_POST['send'] ) ){

	//Exportdatei mit entsprechenden Auswahlen machen
	...
	//Formular für Auswahl, was zu exportieren ist
	$sitecontent->add_site_content('<form action="'.$addonurl.'" method="post">');

	//Seiten
	//	Menü wird deaktiviert, wenn Seiten deaktiviert wird
